...
class NitrogenDAO {
    ...
    // === ADICIONADO: FUNÇÃO PARA CHECAR POSSESSÃO DE NFT COM SUPORTE AO MODE DEV ===
    usuarioPossuiNFT() {
        if (DEV_MODE.forcarPossuiNFT) {
            return true; // Força liberação no ambiente de testes
        }
        
        // No futuro, aqui faremos a checagem real via Web3/Supabase.
        // Por padrão, retorna false para simular o usuário que não tem o NFT.
        return false;
    }
    ...
    mudarAba(aba) {
        ...
        // === CIRURGIA WEB3: TRAVA DE BLOQUEIO SE O USUÁRIO NÃO POSSUI O NFT DO GUARDIÃO ===
        // Bloqueia se o usuário tentar entrar no Perfil (onde estão os jogos), Governança ou NFTs e não tiver a credencial
    ...
    atualizarLayoutCheckIn() {
        ...
        // Configuração global do prêmio surpresa do mês
        ...
        // Controls o comportamento do botão principal de presença diária
    ...
    executarCheckIn() {
        ...
        // 2ª BARREIRA DE SEGURANÇA: Salva a data imediatamente para evitar fraudes de refresh
        ...
        // 3ª BARREIRA DE SEGURANÇA: Grava e atualiza tudo simultaneamente
        this.salvarDadosDApp();
            ...
            containerDados.innerHTML = `
                <div class="card-metricas-dao" style="background: rgba(0,0,0,0.02); border: 1px solid rgba(0,0,0,0.05); padding: 15px; border-radius: 10px; text-align: left;">
                    ...
                    <p style="font-size: 0.75rem; color: #666; line-height: 1.4; margin-bottom: 12px;">
                        Toda receita ou taxa que ingressa no cofre central cumpre a division imutável de governança acordada em contrato:
                    </p>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 10px;">
                        <div style="padding: 10px; background: rgba(40,167,69,0.04); border-left: 4px solid #28A745; border-radius: 0 6px 6px 0;">
                            ...
                            <span style="font-size: 0.7; color: #555;">Destinado à economia circular, apoio social, infraestrutura dos motoristas e incentivos locais.</span>
                        </div>
                        ...
                        <div style="padding: 10px; background: rgba(0,123,255,0.04); border-left: 4px solid #007BFF; border-radius: 0 6px 6px 0;">
                            ...
                            <span style="font-size: 0.7; color: #555;">Fundo estratégico de governança e auditoria de blocos, distribuído proporcionalmente aos 21 líderes activos.</span>
                        </div>
                    </div>
                </div>
            `;
